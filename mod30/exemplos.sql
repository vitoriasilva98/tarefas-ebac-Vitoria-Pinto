...
create table tb_estoque(
                           ...
                           id_produto_fk bigint not null unique,
...
ALTER TABLE TB_CLIENTE ADD COLUMN email VARCHAR(100) NOT NULL UNIQUE;
...
SELECT est.unidade FROM TB_ESTOQUE est
                            INNER JOIN TB_PRODUTO pro ON pro.id = est.id_produto_fk
WHERE est.id_produto_fk = 1;